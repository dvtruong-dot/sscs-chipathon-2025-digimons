...
N 250 -630 300 -630 {lab=vdd}
N 300 -700 300 -630 {lab=vdd}
N 410 -630 480 -630 {lab=vdd}
N 480 -700 480 -630 {lab=vdd}
N 560 -620 650 -620 {lab=vdd}
N 650 -700 650 -620 {lab=vdd}
N 890 -620 970 -620 {lab=vdd}
N 970 -700 970 -620 {lab=vdd}
N 890 -700 970 -700 {lab=vdd}
N 890 -300 890 -160 {lab=vss}
N 880 -160 890 -160 {lab=vss}
N 840 -330 850 -330 {lab=#net1}
N 890 -490 890 -360 {lab=Vo}
N 470 -240 520 -240 {lab=Vi_3}
N 470 -260 470 -240 {lab=Vi_3}
N 890 -330 1000 -330 {lab=vss}
N 1000 -330 1000 -160 {lab=vss}
N 890 -160 1000 -160 {lab=vss}
N 560 -240 680 -240 {lab=vss}
N 680 -240 680 -160 {lab=vss}
N 560 -330 700 -330 {lab=vss}
N 700 -330 700 -160 {lab=vss}
N 560 -430 720 -430 {lab=vss}
N 720 -430 720 -160 {lab=vss}
...
C {symbols/nfet_03v3.sym} 870 -330 0 0 {name=M8
L=0.28u
W=0.22u
nf=1
m=1
