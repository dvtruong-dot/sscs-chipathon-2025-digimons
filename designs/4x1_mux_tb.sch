...
N 990 -510 1000 -510 {lab=V_s0}
N 990 -570 990 -510 {lab=V_s0}
N 950 -570 950 -530 {lab=V_s1}
N 950 -530 1000 -530 {lab=V_s1}
N 910 -520 970 -520 {lab=V_d0}
N 970 -520 970 -490 {lab=V_d0}
N 970 -490 1000 -490 {lab=V_d0}
N 910 -470 1000 -470 {lab=V_d1}
N 910 -480 910 -470 {lab=V_d1}
N 910 -440 990 -440 {lab=V_d2}
N 990 -450 990 -440 {lab=V_d2}
N 990 -450 1000 -450 {lab=V_d2}
N 1000 -430 1000 -400 {lab=V_d3}
N 910 -400 1000 -400 {lab=V_d3}
C {title.sym} -140 60 0 0 {name=l1 author="The Digimons"}
C {vdd.sym} 1300 -590 0 0 {name=l2 lab=VDD}
C {gnd.sym} 1300 -410 0 0 {name=l3 lab=GND}
C {4x1_mux.sym} 1150 -480 0 0 {name=x1}
